...
<Link to="/login" className="bg-black text-white px-3 py-1 md:py-2 rounded-full text-sm flex items-center gap-1 hover:bg-black-800 transition-colors whitespace-nowrap">
